...
const HydrationSection = () => {
  return (
    <>
      ...
      >
        <div className="font-manrope w-full lg:w-[50%] bg-[#EEF8FB] relative flex flex-col items-center justify-center px-4 lg:px-0 order-2 lg:order-1">
        ...
        <div className="w-[80%] mx-auto px-10 sm:px-0 lg:w-[50%] mt-10 lg:mt-0 lg:mx-10 bg-gradient-to-r from-[#1CABE3] to-[#80D261] flex flex-col justify-center items-center rounded-[2rem] lg:rounded-[2rem] order-1 lg:order-2">
