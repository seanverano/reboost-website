  ...
  return (
    <>
      <section className="flex flex-col lg:flex-row w-full min-h-[100vh] bg-[#E8F8EE]">
        <div className="w-[80%] mx-auto px-10 sm:px-0 lg:w-[50%] lg:mx-10 bg-gradient-to-r from-[#80D261] to-[#1CABE3] flex flex-col justify-center items-center rounded-[2rem] lg:rounded-[2rem]">
        ...
        <div className="font-manrope w-full lg:w-[50%] bg-[#E8F8EE] relative flex flex-col items-center justify-center px-4 lg:px-0">
